...
const questions = [
    ...
    {
        "question": "What is the name of the loop structure in Python that continues until a condition is false?",
        "suggestions": {
            "a": "finite loop",
            "b": "while loop",
            "c": "infinite loop",
    ...
    {
        "question": "Which of the following is not a programming language: Python, Java, HTML, Linux?",
        "suggestions": {
            "a": "Python",
            "b": "Java",
            "c": "HTML",
    ...
    {
        "question": "In SQL, which command is used to remove all records from a table but not the table itself?",
        "suggestions": {
            "a": "TRUNCATE",
            "b": "SELECT",
            "c": "JOIN",
...
function loadQuestion() {
    if (index < questions.length) {
        ...
        Object.keys(questions[index]['suggestions']).forEach(k => {
            ...
            let spanText = document.createTextNode(`${k.toUpperCase()} - ${questions[index]['suggestions'][k]}`);
